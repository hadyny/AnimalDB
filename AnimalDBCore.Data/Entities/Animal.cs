namespace  AnimalDBCore.Core.Entities
{
    ...
    public class Animal
    {
        public Animal()
        {
            ...
            this.Parents = new HashSet<ParentChildRelationship>();
            this.Offspring = new HashSet<ParentChildRelationship>();
        ...
        */
        ...
        public virtual IAnimalUser Researcher { get; set; }
        ...
        public virtual ICollection<ParentChildRelationship> Offspring { get; set; }
        public virtual ICollection<ParentChildRelationship> Parents { get; set; }
