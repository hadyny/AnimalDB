var PrintClinicalIncidentReport = (function () {
    ...
    function printreport() {
        ...
        print_window.document.write($('<div />').append($('.clinicalIncidentReport').clone()).html());
...
$(document).ready(PrintClinicalIncidentReport.setup);